...
export const metadata: Metadata = {
  title: "Privacy | Hearthfolio",
  description: "How Hearthfolio handles local learning records, analytics, and license checks."
};
  ...
  return (
    <main className="legal-page">
      ...
      <article className="legal-content">
        ...
        <p>Hearthfolio is designed so the operator does not need a copy of your family’s learning records.</p>

        <section><h2>What stays in your browser</h2><p>Learner names or nicknames, grade labels, learning notes, subjects, dates, attendance selections, and report contents are stored in your browser’s local storage. Hearthfolio does not upload these records or create a cloud account.</p></section>
        ...
        <section><h2>Backups and loss</h2><p>Local storage can be erased if you clear browser data, lose a device, or change browsers. Hearthfolio provides a downloadable backup. You are responsible for keeping a recent backup somewhere safe.</p></section>
        <section><h2>Children’s information</h2><p>Hearthfolio is a tool for a parent or responsible adult. It does not offer child accounts. Use initials or a nickname if you prefer not to store a full name in the browser.</p></section>
